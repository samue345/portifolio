                            ...
                            <div className="flex-grow order-1 md:order-1 md:w-1/2 pl-12 md:pl-0 md:pr-8 md:text-right">
                                <div className="relative bg-white dark:bg-gray-800 p-4 md:p-6 rounded-lg shadow-md group">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <a href="https://www.payt.com.br/" className="inline-flex items-center gap-1 text-blue-500 dark:text-blue-400 mb-2 hover:text-blue-600 dark:hover:text-blue-300 transition-colors group" target="_blank" rel="noopener noreferrer">OtimizeMe -Payt
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-external-link w-4 h-4"><path d="M15 3h6v6"></path><path d="M10 14 21 3"></path><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path></svg>
                                        </a>
                                        <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mb-3">2024/03 - Present</p>
                                        <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 mb-3">Developed full-stack web applications and reusable components to deliver fast, responsive user experiences and support scalable business workflows.</p>
                            ...
                            <div className="flex-grow order-1 md:order-3 md:w-1/2 pl-12 md:pl-8">
                                <div className="relative bg-white dark:bg-gray-800 p-4 md:p-6 rounded-lg shadow-md group">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mb-3">2021 - 2027</p>
