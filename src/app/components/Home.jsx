        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-16 sm:py-24">
            <div className="text-center z-10 max-w-3xl mx-auto fade-in-up">
                <div className="relative mb-8 inline-block">
                    <img src="./images/foto_perfil.jpeg" alt="Foto de perfil" className="w-48 h-48 rounded-full border-4 border-white dark:border-gray-800 shadow-lg object-cover" />
                </div>
                ...
                "Web Developer specialized in Frontend and Backend Development, API integration, and Web Performance Optimization, with 3+ years of experience building scalable, user-focused applications that enhance digital experiences and support business growth."</p>
                <div className="flex gap-4 sm:gap-6 justify-center">
                    <a className="p-2 sm:p-3 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 hover-scale"
                       target="_blank" href="https://wa.me/5511954694681" rel="noreferrer">
                    ...
                    <a href="https://github.com/samue345" target="_blank" rel="noopener noreferrer" className="p-2 sm:p-3 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 hover-scale" aria-label="GitHub Profile">
                    ...
                    <a href="https://www.linkedin.com/in/samuel-souza-p-dev/" target="_blank" rel="noopener noreferrer" className="p-2 sm:p-3 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 hover-scale" aria-label="Connect on LinkedIn">
                    ...
                    <a href="mailto:samuef339@gmail.com" className="p-2 sm:p-3 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 hover-scale" aria-label="Send Email">
